...
```
NEXT_PUBLIC_DOMAIN=site.EXAMPLE.com
NEXT_PUBLIC_HOSTED_ZONE_NAME=EXAMPLE.com
NEXT_PUBLIC_HOSTED_ZONE_ID=123ASDFGH456AQWER34T4V1C
NEXT_PUBLIC_USER_API_URL_LOCAL_SAM=http://localhost:3001/users
```

*Note: You should not have to change `NEXT_PUBLIC_USER_API_URL_LOCAL_SAM` as the demo is designed to work on `localhost:3001`.*
